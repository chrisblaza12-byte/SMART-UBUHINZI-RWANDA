...
export function HomePage({ onOpenAuth, onOpenMarketplace, onGoToSection, onGoToDashboard, language }: HomePageProps) {
  ...
  return (
    <div className="space-y-12 pb-12 sm:space-y-16 sm:pb-16 2xl:space-y-20 2xl:pb-20">
      <section
        id="hero"
        className="relative overflow-hidden border-b border-[#CBD5E1] dark:border-[#334155]/50"
        style={{
          backgroundImage: `linear-gradient(rgba(2,6,23,0.82), rgba(15,23,42,0.86)), url('/hh.jpg')`,
          backgroundSize: "cover",
          backgroundPosition: "center",
        }}
      >
        <div className="relative mx-auto grid max-w-7xl gap-10 px-4 py-14 sm:px-6 sm:py-20 lg:grid-cols-2 lg:items-center lg:gap-14 xl:px-8 2xl:max-w-[1800px] 2xl:gap-20 2xl:px-12 2xl:py-28">
          <div className="space-y-5">
            ...
            />
            <h1 className="text-3xl font-extrabold leading-tight text-[#F8FAFC] sm:text-5xl md:text-6xl 2xl:text-7xl">
              Modern Farming Starts Here: <span className="text-[#4ADE80]">{heroWords[wordIndex]}</span>
            </h1>
            <p className="max-w-xl text-base leading-7 text-[#CBD5E1] sm:text-lg 2xl:max-w-2xl 2xl:text-xl 2xl:leading-8">
          ...
          <div className="grid gap-3 sm:grid-cols-2 lg:gap-4 2xl:gap-5">
      ...
      <section id="services" className="mx-auto max-w-7xl px-4 sm:px-6 xl:px-8 2xl:max-w-[1800px] 2xl:px-12">
        <h2 className="text-center text-3xl font-bold text-[#0F172A] dark:text-[#F8FAFC]">{t.home.quickServices}</h2>
        <div className="mt-6 grid gap-3 sm:mt-8 sm:grid-cols-2 sm:gap-4 xl:grid-cols-4 2xl:gap-5">
      ...
      <section id="ai-detection" className="mx-auto max-w-7xl rounded-2xl border border-[#CBD5E1] bg-white px-4 py-6 dark:border-[#334155] dark:bg-[#0F172A] sm:px-6 sm:py-8 xl:px-8 2xl:max-w-[1800px] 2xl:px-12 2xl:py-12">
      ...
      <section id="weather" className="mx-auto max-w-7xl px-4 sm:px-6 xl:px-8 2xl:max-w-[1800px] 2xl:px-12">
      ...
      <section id="news" className="mx-auto max-w-7xl px-4 sm:px-6 xl:px-8 2xl:max-w-[1800px] 2xl:px-12">
      ...
      <section className="mx-auto max-w-7xl rounded-2xl border border-[#CBD5E1] bg-white p-4 dark:border-[#334155] dark:bg-[#1A1E2F] sm:p-6 xl:p-8 2xl:max-w-[1800px] 2xl:p-10">
